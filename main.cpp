 ...
 */
 ...
 glColor3f(0.0,0.0,0.0); //roda
 glTranslatef(-3,8,17);
 glTranslatef(-22,-8,-17);
 cylinder(5, 5,3);

 glColor3f(0.0,0.0,0.0); //pintu
 glRotatef(90,1,0,0);
...
int main(int argc,char **argv)
{
 ...
 glutCreateWindow("Mobil Ambulance");
